# Generated by Django 5.1.7 on 2025-04-16 14:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('processing', 'Processing'), ('fulfilled', 'Fulfilled')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='batches', to='warehouse_inventory.item')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
